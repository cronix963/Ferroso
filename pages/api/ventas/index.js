  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const result = await query(
        `INSERT INTO ventas (pedido_id, vendedor_id, cliente_id, total, metodo_pago, notas) VALUES ($1,$2,$3,$4,$5,$6) RETURNING id`,
        [pedido_id||null, vendedor_id||null, cliente_id||null, total||0, metodo_pago||null, notas||null]
      );
      return res.status(201).json({ message: 'Venta registrada', id: result.rows[0].id });
    }
