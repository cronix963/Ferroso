  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const result = await query(
        `INSERT INTO pagos_cobros (tipo, referencia_id, referencia_tipo, monto, metodo, concepto) VALUES ($1,$2,$3,$4,$5,$6) RETURNING id`,
        [tipo, referencia_id||null, referencia_tipo||null, monto, metodo, concepto||null]
      );
      return res.status(201).json({ message: 'Pago registrado', id: result.rows[0].id });
    }
